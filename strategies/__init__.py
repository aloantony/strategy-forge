...
"""
Paquete de estrategias del bot.


- Piensa que esta carpeta es una caja con varios "cerebros".
- Cada archivo de estrategia decide si toca comprar, vender o esperar.
"""
